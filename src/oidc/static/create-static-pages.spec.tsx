...
describe('generateStaticPagesModule', function() {
  let exports: Record<string, (props: React.ComponentProps<typeof Component>) => string>;
  ...
  it('includes selected props', function() {
    expect(exports.Component({ prop1: 'prop1value' })).to.match(/<h1[^>]+>prop1value<\/h1>/);
    expect(exports.Component({ prop1: 'prop1value' })).not.to.include('prop2');
    expect(exports.Component({ prop1: 'prop1value' })).not.to.include('data-attr');
    expect(exports.Component({ prop2: 'prop2value' })).to.match(/<h1[^>]+>default<\/h1>/);
    expect(exports.Component({ prop2: 'prop2value' })).to.match(/<p[^>]+>prop2value<\/p>/);
    expect(exports.Component({ prop2: 'prop2value' })).to.include('data-attr="prop2value"');
  });

  it('properly escapes props', function() {
    expect(exports.Component({ prop2: 'prop2<&"\'>value' })).to.include('data-attr="prop2&lt;&amp;&quot;&#039;&gt;value"');
    expect(exports.Component({ prop2: 'prop2<&"\'>value' })).to.include('>prop2&lt;&amp;&quot;&#039;&gt;value</p>');
  });
